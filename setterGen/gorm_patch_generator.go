...
func generateGormPatchFileForMultiple(filename string, gormModels []*GormModelInfo) error {
	if len(gormModels) == 0 {
...
func generateGormPatchFile(filename string, gormModel *GormModelInfo) error {
	var sb strings.Builder
